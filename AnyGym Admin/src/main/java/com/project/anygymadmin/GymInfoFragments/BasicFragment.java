...
import com.project.anygymadmin.Adapter.GymInfoImageAdapter;
...
public class BasicFragment extends Fragment{
    private GymInfoImageAdapter imageAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageAdapter = new GymInfoImageAdapter(getContext(), Integer.parseInt(myDataHolder.about.split("#")[1]));
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        getActivity().getMenuInflater().inflate(R.menu.gym_info_menu, menu);
